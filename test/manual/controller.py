...
class KindLoader:
    """Получение и загрузка существ(а) из файла."""
    ...
    def load(cls) -> list[Kind]: 
        """Загружает существ(о) из файла ('*.kind')"""
        kinds = []
...
class Application:
    """ Управляющий класс (провеки файла с данными существа, сохранение существа"""
    def __init__(self):
        self.view = None
    ...
    def save_creature(self):
        """Сохраняет данные существа в файл"""
        ...
